...
// Now Function Expression: is ma hum 1 function ko 1 variable ma assing kr deta ha example below
...
// i will face the problem like this where i have already created the function with the name and im not
// getting any errors.
function sayHello() {console.log("Hello")}
function sayHello() {console.log("Hello New")}
