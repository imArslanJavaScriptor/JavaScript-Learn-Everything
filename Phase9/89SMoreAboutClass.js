...
console.log(tommy.eat()) // Now This is Comming From Base Class BCZ JavaScript First check insiede trhe current class if not get the rewuried methiod then move to the Parent class